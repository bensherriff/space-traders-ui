...
impl FactionTraitType {
  pub fn from_str(s: &str) -> Option<FactionTraitType> {
    match s {
      "Bureaucratic" => Some(FactionTraitType::Bureaucratic),
      "Secretive" => Some(FactionTraitType::Secretive),
      "Capitalistic" => Some(FactionTraitType::Capitalistic),
      "Industrious" => Some(FactionTraitType::Industrious),
      "Peaceful" => Some(FactionTraitType::Peaceful),
      "Distrustful" => Some(FactionTraitType::Distrustful),
      "Welcoming" => Some(FactionTraitType::Welcoming),
      "Smugglers" => Some(FactionTraitType::Smugglers),
      "Scavengers" => Some(FactionTraitType::Scavengers),
      "Rebellious" => Some(FactionTraitType::Rebellious),
      "Exiles" => Some(FactionTraitType::Exiles),
      "Pirates" => Some(FactionTraitType::Pirates),
      "Raiders" => Some(FactionTraitType::Raiders),
      "Clan" => Some(FactionTraitType::Clan),
      "Guild" => Some(FactionTraitType::Guild),
      "Dominion" => Some(FactionTraitType::Dominion),
      "Fringe" => Some(FactionTraitType::Fringe),
      "Forsaken" => Some(FactionTraitType::Forsaken),
      "Isolated" => Some(FactionTraitType::Isolated),
      "Localized" => Some(FactionTraitType::Localized),
      "Established" => Some(FactionTraitType::Established),
      "Notable" => Some(FactionTraitType::Notable),
      "Dominant" => Some(FactionTraitType::Dominant),
      "Inescapable" => Some(FactionTraitType::Inescapable),
      "Innovative" => Some(FactionTraitType::Innovative),
      "Bold" => Some(FactionTraitType::Bold),
      "Visionary" => Some(FactionTraitType::Visionary),
      "Curious" => Some(FactionTraitType::Curious),
      "Daring" => Some(FactionTraitType::Daring),
      "Exploratory" => Some(FactionTraitType::Exploratory),
      "Resourceful" => Some(FactionTraitType::Resourceful),
      "Flexible" => Some(FactionTraitType::Flexible),
      "Cooperative" => Some(FactionTraitType::Cooperative),
      "United" => Some(FactionTraitType::United),
      "Strategic" => Some(FactionTraitType::Strategic),
      "Intelligent" => Some(FactionTraitType::Intelligent),
      "Research Focused" => Some(FactionTraitType::ResearchFocused),
      "Collaborative" => Some(FactionTraitType::Collaborative),
      "Progressive" => Some(FactionTraitType::Progressive),
      "Militaristic" => Some(FactionTraitType::Militaristic),
      "Technologically Advanced" => Some(FactionTraitType::TechnologicallyAdvanced),
      "Aggressive" => Some(FactionTraitType::Aggressive),
      "Imperialistic" => Some(FactionTraitType::Imperialistic),
      "Treasure Hunters" => Some(FactionTraitType::TreasureHunters),
      "Dexterous" => Some(FactionTraitType::Dexterous),
      "Unpredictable" => Some(FactionTraitType::Unpredictable),
      "Brutal" => Some(FactionTraitType::Brutal),
      "Fleeting" => Some(FactionTraitType::Fleeting),
      "Adaptable" => Some(FactionTraitType::Adaptable),
      "Self Sufficient" => Some(FactionTraitType::SelfSufficient),
      "Defensive" => Some(FactionTraitType::Defensive),
      "Proud" => Some(FactionTraitType::Proud),
      "Diverse" => Some(FactionTraitType::Diverse),
      "Independent" => Some(FactionTraitType::Independent),
      "Self Interested" => Some(FactionTraitType::SelfInterested),
      "Fragmented" => Some(FactionTraitType::Fragmented),
      "Commercial" => Some(FactionTraitType::Commercial),
      "Free Markets" => Some(FactionTraitType::FreeMarkets),
      "Entrepreneurial" => Some(FactionTraitType::Entrepreneurial),
      _ => None
    }
  }
}